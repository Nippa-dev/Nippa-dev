# 👨‍💻 Nipun Sanchitha (K.L. Nipun Sanchitha) 

### 🛡️ Cybersecurity Graduate | ☁️ DevOps & Systems Explorer | 📊 HR Data Analytics
...
| :--- | :--- |
| **Security** | Penetration Testing, Network Scanning (Nmap/Wireshark), VPN Config (LKTunnel), Parrot OS |
| **Networking** | SDN Infrastructure, Cisco Router/Switch Configuration, Advanced Networking |
| **Cloud & DevOps** | AWS (EC2, OpenVPN Setup), Docker, Linux System Administration |
